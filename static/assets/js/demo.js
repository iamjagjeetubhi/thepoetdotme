...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
  ...
  FieldError: function(from, align){
    	color = Math.floor((Math.random() * 4) + 1);
  ...
  NonFieldError: function(from, align){
    	color = Math.floor((Math.random() * 4) + 1);

    	$.notify({
        	icon: "ti-hand-point-down  ",
    ...
    SignUpEmail: function(from, align){
      	color = Math.floor((Math.random() * 4) + 1);
    ...
    SignUpPassword: function(from, align){
        color = Math.floor((Math.random() * 4) + 1);
    ...
    EmailSent: function(from, align){
        color = Math.floor((Math.random() * 4) + 1);

        $.notify({
            icon: "ti-key",
            message: "We have sent you a message with a confirmation link. Please click the link in the message to confirm your email address and complete the registration."
          },{
              type: type[2],
              timer: 4000,
              placement: {
